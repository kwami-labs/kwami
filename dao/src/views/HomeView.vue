    ...
    <div class="dashboard-grid">
      ...
      <div class="right-column">
        ...
        <div v-if="governanceStore.activeProposals.length > 0" class="view-all">
          <BaseButton to="/proposals" variant="outline" block>
            View All Proposals
          </BaseButton>
        </div>
      </div>
...
import NFTVerification from '@/components/NFTVerification.vue';
import QwamiBalance from '@/components/QwamiBalance.vue';
