...
export interface MediaSectionOptions extends ComponentProps {
  kwami?: any;
}
...
export class MediaSection {
  ...
  private render(): void {
    ...
    const icon = createIcon({ name: 'heroicons:film', size: '48px', color: 'var(--kwami-color-text-muted)' }).element;
