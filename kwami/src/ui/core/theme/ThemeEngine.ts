  ...
  private generateComponentStyles(): string {
    return `
      ...
      .kwami-card__header {
        ...
        padding-bottom: var(--kwami-padding-sm);
      }
      
      .kwami-card__title {
        font-size: var(--kwami-font-size-lg);
        font-weight: var(--kwami-font-weight-bold);
        color: var(--kwami-color-text);
        min-width: 0;
      }
      
      .kwami-card__header-right {
        font-size: var(--kwami-font-size-xs);
        font-weight: var(--kwami-font-weight-semibold);
        letter-spacing: var(--kwami-letter-spacing-wide);
        text-transform: uppercase;
        color: var(--kwami-color-text-muted);
      ...
      .kwami-input {
        ...
        color: var(--kwami-color-text);
        border: var(--kwami-border-width) solid var(--kwami-color-border);
        border-radius: var(--kwami-radius-sm);
        padding: var(--kwami-input-padding-vertical) var(--kwami-input-padding-horizontal);
        font-family: var(--kwami-font-family);
        font-size: var(--kwami-font-size);
        line-height: var(--kwami-line-height);
        transition: box-shadow var(--kwami-duration) var(--kwami-easing),
                    border-color var(--kwami-duration) var(--kwami-easing);
      }
      ...
      .kwami-input:focus {
        outline: none;
        border-color: var(--kwami-color-border-focus);
        box-shadow: 0 0 0 3px color-mix(in srgb, var(--kwami-color-primary) 25%, transparent);
      }
