<template>
  <div class="space-y-4">
    <div ref="canvasContainer" class="relative w-full h-96 bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
      <canvas ref="canvas" class="w-full h-full" />
      <div v-if="loading" class="absolute inset-0 flex items-center justify-center bg-gray-50/80 dark:bg-gray-900/80">
