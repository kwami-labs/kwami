...
Kwami community a harassment-free experience for everyone, regardless of age,
...
issues, pull requests, discussions, and any official Kwami presence — and also
applies when an individual is officially representing the community in public
spaces.

## Enforcement

Report incidents to the maintainers at <alexcollsoutumuro@gmail.com> or by
opening a confidential [GitHub Security Advisory][advisory] if the report
involves a vulnerability. Do not post accusations in a public issue.
...
[advisory]: https://github.com/kwami-labs/kwami/security/advisories/new
