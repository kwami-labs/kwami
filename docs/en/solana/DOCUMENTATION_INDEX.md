...
#### **Main README**
**File:** [`anchor/kwami-nft/README.md`](https://github.com/alexcolls/kwami/blob/main/solana/anchor/kwami-nft/README.md)
...
#### **Smart Contract**
**File:** [`anchor/kwami-nft/programs/kwami-nft/src/lib.rs`](https://github.com/alexcolls/kwami/blob/main/solana/anchor/kwami-nft/programs/kwami-nft/src/lib.rs)
...
#### **Main README**
**File:** [`anchor/qwami-token/README.md`](https://github.com/alexcolls/kwami/blob/main/solana/anchor/qwami-token/README.md)
...
**File:** [`anchor/qwami-token/UPDATES.md`](https://github.com/alexcolls/kwami/blob/main/solana/anchor/qwami-token/UPDATES.md)
...
### **Metaplex Guide**
**File:** [`metaplex/README.md`](https://github.com/alexcolls/kwami/blob/main/solana/metaplex/README.md)
...
### **Collection Metadata**
**File:** [`metaplex/collection/collection-metadata.json`](https://github.com/alexcolls/kwami/blob/main/solana/metaplex/collection/collection-metadata.json)
...
### **Deployment Scripts**
**Files:**
- [`scripts/fund-devnet.sh`](https://github.com/alexcolls/kwami/blob/main/solana/scripts/fund-devnet.sh)
- [`scripts/initialize-collection.sh`](https://github.com/alexcolls/kwami/blob/main/solana/scripts/initialize-collection.sh)
...
→ Follow [`SETUP.md`](./SETUP.md) then [`anchor/kwami-nft/README.md`](https://github.com/alexcolls/kwami/blob/main/solana/anchor/kwami-nft/README.md)
...
### **I want to mint NFTs**
→ Check [`../candy/README.md`](../candy/README.md) and [`metaplex/README.md`](https://github.com/alexcolls/kwami/blob/main/solana/metaplex/README.md)

### **I want to understand tokenomics**
→ See [`anchor/qwami-token/README.md`](https://github.com/alexcolls/kwami/blob/main/solana/anchor/qwami-token/README.md)
