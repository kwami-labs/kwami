...
**Returns:** Version string (e.g., "1.5.12")
...
- **[Body API](../core/body.md)** - Visual component API
- **[Mind API](../core/mind.md)** - AI component API
- **[Soul API](../core/soul.md)** - Personality component API
