...
Welcome to the Kwami documentation. Kwami is an independent, reusable 3D Interactive AI Companion Library for creating engaging AI companions with visual (blob), audio, and AI capabilities.
...
- **[Soul API](./api/soul.md)** - Personality management
- **[Audio API](./api/audio.md)** - Audio playback and analysis
...
- **[Background System](./guides/backgrounds.md)** - Background media management
...
- 🧠 **Mind Provider Architecture** - Multi-vendor AI provider support
- 🌈 **Gradient Overlays** - Enhanced background system with Three.js gradients
- 🎭 **Emotional Personality System** - Rich emotional trait spectrum
- 🤖 **OpenAI Provider** - Experimental OpenAI TTS integration
- 📚 **Complete Documentation** - Mind, Body, and Soul READMEs

## 💡 Need Help?

- **Questions?** Open a [GitHub Issue](https://github.com/alexcolls/kwami/issues)
- **Examples** Check out the [playground](../playground/) for live examples
