...
#### Usage Example
```typescript
import { uploadCompleteKwamiNFT } from 'https://github.com/alexcolls/kwami/blob/main/solana/metaplex/utils/uploadToArweave';
...
cd ../..
https://github.com/alexcolls/kwami/blob/main/solana/scripts/initialize-collection.sh
```
...
- [anchor/qwami-token/README.md](https://github.com/alexcolls/kwami/blob/main/solana/anchor/qwami-token/README.md) - Token program docs
- [anchor/kwami-nft/README.md](https://github.com/alexcolls/kwami/blob/main/solana/anchor/kwami-nft/README.md) - NFT program docs
- [metaplex/README.md](https://github.com/alexcolls/kwami/blob/main/solana/metaplex/README.md) - Metaplex integration
