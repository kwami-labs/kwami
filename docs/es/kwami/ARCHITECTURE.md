...
High-level architecture overview for Kwami v1.5.12100. For detailed component architecture, see the [architecture documentation](./architecture/).
...
└── docs/                         # Documentation
    ├── kwami/                  # Core library docs
    ├── pg/                     # Playground docs
    ├── app/                    # App docs
    ├── solana/                 # Solana docs
    ├── candy/                  # Candy machine docs
    ├── market/                 # Marketplace docs
    ├── dao/                    # DAO docs
    └── web/                    # Website docs
```
...
**See:** [Contributing Guide](https://github.com/alexcolls/kwami/blob/main/CONTRIBUTING.md.md)
...
├── pg/                        # Playground documentation
├── app/                       # Web application documentation
├── solana/                    # Solana programs documentation
├── candy/                     # Candy machine documentation
├── market/                    # Marketplace documentation
...
- **[Playground](../pg/README.md)** - Interactive demo documentation
- **[Kwami App](../app/README.md)** - Full application documentation
- **[Solana Programs](../solana/README.md)** - Smart contracts documentation
- **[Candy Machine](../candy/README.md)** - NFT minting documentation
- **[Marketplace](../market/README.md)** - NFT trading documentation
- **[DAO](../dao/README.md)** - Governance documentation
- **[Website](../web/README.md)** - Public website documentation
...
See [CHANGELOG](https://github.com/alexcolls/kwami/blob/main/CHANGELOG.md.md) and [kwami/CHANGELOG.md](../../kwami/CHANGELOG.md) for complete version history.
...
See [LICENSE](https://github.com/alexcolls/kwami/blob/main/LICENSE.md) for full terms.
