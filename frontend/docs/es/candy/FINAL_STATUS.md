...
**Version:** 1.5.12 → 1.5.0 (Implementation Complete)  
...
```json
{
  "anchor:build": "https://github.com/alexcolls/kwami/blob/main/solana/scripts/build-anchor.sh",
  "anchor:test": "https://github.com/alexcolls/kwami/blob/main/solana/scripts/test-anchor.sh",
  "anchor:deploy": "https://github.com/alexcolls/kwami/blob/main/solana/scripts/deploy-anchor.sh devnet",
  "anchor:deploy:mainnet": "https://github.com/alexcolls/kwami/blob/main/solana/scripts/deploy-anchor.sh mainnet-beta"
}
```
